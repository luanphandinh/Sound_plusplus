...
public class CoverCache {
    /**
     * Trả về size của small album covers
     * This is 44sp * 2 = xhdpi resolution. Ta nên tính toán bằng tay
     */
    public final static int SIZE_SMALL = 88;
    /**
     * Trả về size của large (cover view) album covers
     */
    public final static int SIZE_LARGE = 600;
    /**
     * Sử dụng tất cả providers để load cover art
     */
    public static final int COVER_MODE_ALL = 0xF;
    /**
     * Sử dụng android buildtin cover mechanism để load covers
     */
    public static final int COVER_MODE_ANDROID = 0x1;
    /**
     * Sử dụng soundplusplus musics cover load mechanism =))))
     */
    public static final int COVER_MODE_VANILLA = 0x2;
    /**
     * Sử dụng soundplusplus musics SHADOW cover load mechanism
     */
    ...
    /**
     * Xóa tất cả các items được lưu trong Cache
     */
    ...
    /**
     *  Đối tương được sử dụng như CacheKey. Các object có cùng
     *  media type, id and size được coi như là bằng nhau
     */
        ...
        public Bitmap createBitmap(Song song, long maxPxCount) {
            ...
            try {
                ...
                if (inputStream == null && (CoverCache.mCoverLoadMode & CoverCache.COVER_MODE_SHADOW) != 0) {
                    String shadowPath = "/sdcard/Music/.soundplusplus/"+(song.artist.replaceAll("/", "_"))+"/"+(song.album.replaceAll("/", "_"))+".jpg";
